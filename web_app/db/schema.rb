...
ActiveRecord::Schema.define(version: 20170907202115) do
  ...
  create_table "referreds", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["user_id"], name: "index_referreds_on_user_id", using: :btree
  end
  ...
  create_table "spree_users", force: :cascade do |t|
    ...
    t.text     "middle_name"
    t.text     "last_name"
    t.text     "second_last_name"
    t.date     "birth_day"
    t.text     "type_of_document"
  ...
  add_foreign_key "referreds", "users"
